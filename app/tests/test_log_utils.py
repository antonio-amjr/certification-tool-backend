...
mocked_test_run_execution = schemas.TestRunExecutionWithChildren(
    ...
    test_collection_executions=[
        schemas.TestCollectionExecution(
            name="Collection0",
            state=TestStateEnum.PASSED,
            execution_index=0,
            id=1,
            test_run_execution_id=1,
            test_collection_metadata_id=1,
            started_at=None,
            completed_at=None,
            errors=None,
            test_suite_executions=[
                schemas.TestSuiteExecution(
                    ...
                    public_id="Suite0",
                    execution_index=0,
                    test_collection_execution_id=1,
                    id=1,
                ...
                schemas.TestSuiteExecution(
                    ...
                    public_id="Suite1",
                    execution_index=1,
                    test_collection_execution_id=2,
                    id=2,
            ...
            test_collection_metadata=schemas.TestCollectionMetadata(
                name="Collection0",
                version="1.0",
                source_hash="abc123",
                id=0,
